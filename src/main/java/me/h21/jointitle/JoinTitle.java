...
@Plugin(id = "jointitle", name = "JoinTitle", authors = {"h21/DeLanau"}, description = "Join Title plugin recoded",
        dependencies = {@Dependency(id = "luckperms", optional = true), @Dependency(id = "placeholderapi")})
public class JoinTitle {
    ...
    private static JoinTitle instance;

    public static JoinTitle getInstance() {
        return instance;
    }
    ...
    public void preInit(GamePreInitializationEvent event) {
        Config.buildConfig(loader, configFile);
    }
